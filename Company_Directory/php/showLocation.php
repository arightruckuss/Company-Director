            ...
            <?php
                        if($result->num_rows > 0){
                            while($row = $result->fetch_assoc()){
                                ...
                                echo "<a class='btn btn-secondary' href='editLocation.php?id=" . $row['id'] ."'>Edit</a>";
                                echo "<a class='btn btn-danger' href='deleteLocation.php?id=" . $row['id'] ."'>Delete</a>";
                                echo "<a class='btn btn-success' href='showDepartments.php?id=" . $row['id'] ."'>Departments</button>";
                                echo "</div>";
                                echo "</td>";
                                echo "</tr>";
                            }
                        ...
                        echo "<a class='btn btn-primary' href='newDepartment.php?id=" . $row['id'] ."'>New</button>";
                        echo "</div>";
            ?>
